...
export default function AdminCategories() {
  ...
  const load = () => adminAPI.getCategories().then(r => setCats(r.data)).catch(() => {})
  useEffect(() => { load() }, [])
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 24 }}>
        ...
        <div className="card" style={{ overflow: 'hidden', height: 'fit-content' }}>
          <table>
            ...
            <tbody>
              {cats.length === 0 ? (
                <tr><td colSpan={2} style={{ textAlign: 'center', padding: 32, color: 'var(--text3)' }}>No categories yet</td></tr>
              ) : cats.map(c => (
                <tr key={c.id}>

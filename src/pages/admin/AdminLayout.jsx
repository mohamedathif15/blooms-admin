...
export default function AdminLayout() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <aside style={{
        width: 230, background: 'var(--green)', color: '#fff',
        ...
        <div style={{ padding: '20px 20px 16px', borderBottom: '1px solid rgba(255,255,255,.15)' }}>
          ...
          <div style={{
            fontSize: 11, background: 'var(--gold)', color: '#111',
            padding: '2px 8px', borderRadius: 4,
            display: 'inline-block', marginTop: 6, fontWeight: 700
          }}>ADMIN PANEL</div>
        </div>
        ...
        <div style={{ padding: '14px 20px', borderTop: '1px solid rgba(255,255,255,.15)' }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#fff', padding: '7px 12px', borderRadius: 5,
              cursor: 'pointer', fontSize: 12, marginBottom: 6, width: '100%'
            }}>
          ...
          <button
            ...
            style={{
              display: 'flex', alignItems: 'center', gap: 6,
              background: 'rgba(255,80,80,.25)', border: 'none',
              color: '#fff', padding: '7px 12px', borderRadius: 5,
